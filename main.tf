...
module "asset_sufficient_levels" {
  source = "https://github.com/alisonjenkins/terraform-null-assertion/archive/refs/heads/add-opentofu-support.zip//terraform-null-assertion-add-opentofu-support"
  # version       = "~>0.2.7"
